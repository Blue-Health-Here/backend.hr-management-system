...
export const buildQuery = <T extends CompanyEntityBase | EntityBase>(fetchRequest: IFetchRequest<T>, getOnlyActive: boolean = false, dontGetDeleted: boolean = true, companyId?: string): FindManyOptions<T> => {
...
export const queryOptionsMapper = <T extends CompanyEntityBase | EntityBase>(filters: Array<IFilter<T, keyof T>>, getOnlyActive: boolean = false, dontGetDeleted: boolean = true, companyId?: string): Array<FindOptionsWhere<T>> => {
